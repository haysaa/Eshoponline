    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "2.4 GHz, 1600 DPI, USB alıcı dâhil", "/images/products/mouse.jpg", 299.90m, "Wireless Mouse", 150 },
                    { 2, 1, "Bluetooth 5.3, 40 h pil ömrü", "/images/products/headphones.jpg", 1499.00m, "Noise-Cancelling Headphones", 85 },
                    { 3, 2, "100 % pamuk, slim-fit, siyah", "/images/products/tshirt.jpg", 129.90m, "Men's Basic T-Shirt", 500 },
